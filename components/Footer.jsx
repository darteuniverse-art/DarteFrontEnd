...
const Footer = () => {
    ...
    const socialIcons = [
        { icon: TikTokIcon, link: "https://www.tiktok.com/@darte.universe?_r=1&_t=ZS-92u8r5LO0iv" },
        { icon: TelegramIcon, link: "https://t.me/darte_universe" },
        { icon: WhatsAppIcon, link: "https://whatsapp.com/channel/0029Vb6c9qB4tRroHm7tzv2u" },
    ];
                ...
                <div className="flex flex-col md:flex-row items-start justify-between gap-10 py-10 border-b border-slate-500/30 text-slate-500">
                    <div>
                        <Link href="/" className="text-4xl font-semibold text-slate-700">
                            <span className="text-green-600">D</span>arté<span className="text-green-600 text-5xl leading-0">.</span>
                        </Link>
                        <p className="max-w-[410px] mt-6 text-sm">
                            Welcome to Darté, the ultimate student marketplace. Join other student in your university's marketplace. We bring you the best vibe that'll help boost your CGPA — all in one place.
                        </p>
