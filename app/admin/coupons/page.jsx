  ...
  return (
    <div className="text-slate-500  mb-40">
      ...
      >
        ...
        <div className="flex gap-2 max-sm:flex-col mt-2">
          <input
            ...
            className="w-full mt-2 p-2 border border-slate-200 dark:border-slate-600 outline-slate-400 dark:outline-slate-600 rounded-md"
            name="code"
        ...
        <label>
          ...
          <input
            ...
            className="w-full mt-1 p-2 border border-slate-200 dark:border-slate-600 outline-slate-400 dark:outline-slate-600 rounded-md"
            name="expiresAt"
        ...
        <div className="mt-5">
          <div className="flex gap-2 mt-3">
            <label className="relative inline-flex items-center cursor-pointer text-gray-900 dark:text-white gap-3">
              ...
              />
              <div className="w-11 h-6 bg-slate-300 rounded-full peer peer-checked:bg-green-600 transition-colors dark:bg-slate-600 dark:peer-checked:bg-green-500 duration-200"></div>
        ...
        <button className="mt-4 p-2 px-10 rounded bg-slate-700 text-white dark:bg-slate-600 dark:text-white active:scale-95 transition">
          Add Coupon
        </button>
      </form>
      ...
      <div className="mt-14">
        ...
        <div className="overflow-x-auto mt-4 rounded-lg border border-slate-200 dark:border-slate-600 max-w-4xl">
          <table className="min-w-full bg-white text-sm">
            <thead className="bg-slate-50 dark:bg-slate-600">
              <tr>
                <th className="py-3 px-4 text-left font-semibold text-slate-600 dark:text-white">
                  Code
                </th>
                <th className="py-3 px-4 text-left font-semibold text-slate-600 dark:text-white">
                  Description
