  ...
  return (
    <>
      ...
      <table className="w-full max-w-4xl text-left  ring ring-slate-200 dark:ring-slate-700 rounded overflow-hidden text-sm">
        <thead className="bg-slate-50 text-gray-700 dark:text-slate-400 dark:bg-slate-700 uppercase tracking-wider">
          <tr>
            ...
            >
              ...
              <td className="px-4 py-3 text-center">
                <label className="relative inline-flex items-center cursor-pointer text-gray-900 dark:text-white gap-3">
                  ...
                  />
                  <div className="w-9 h-5 bg-slate-300 dark:bg-slate-700 rounded-full peer peer-checked:bg-green-600 transition-colors duration-200"></div>
                  <span className="dot absolute left-1 top-1 w-3 h-3 bg-white dark:bg-slate-700 rounded-full transition-transform duration-200 ease-in-out peer-checked:translate-x-4"></span>
                </label>
              </td>
            </tr>
          ))}
